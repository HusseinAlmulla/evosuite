...
public class DiversityCoverageFactory extends
	...
	private static final Logger logger = LoggerFactory.getLogger(DiversityCoverageFactory.class);
	...
	public List<DiversityCoverageTestFitness> getCoverageGoals() {
		List<DiversityCoverageTestFitness> goals = new ArrayList<DiversityCoverageTestFitness>();
	...
	private List<DiversityCoverageTestFitness> getCoverageGoals(Class<?> clazz, String className) {
		List<DiversityCoverageTestFitness> goals = new ArrayList<DiversityCoverageTestFitness>();
		...
		for (Constructor<?> c : allConstructors) {
			if (TestUsageChecker.canUse(c)) {
				...
				goals.add(new DiversityCoverageTestFitness(className, methodName));
			}
		}
	 ...
	 *         object.
	 */
	public static DiversityCoverageTestFitness createMethodTestFitness(
			String className, String method) {

		return new DiversityCoverageTestFitness(className,
