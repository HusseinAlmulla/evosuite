 ...
 */
public class DiversityCoverageTestFitness extends TestFitnessFunction {
     ...
     */
    public DiversityCoverageTestFitness(String className, String methodName) throws IllegalArgumentException{
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DiversityCoverageTestFitness other = (DiversityCoverageTestFitness) obj;
    ...
    public int compareTo(TestFitnessFunction other) {
        if (other instanceof DiversityCoverageTestFitness) {
            DiversityCoverageTestFitness otherMethodFitness = (DiversityCoverageTestFitness) other;
